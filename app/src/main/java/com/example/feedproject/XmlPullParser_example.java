...
public class XmlPullParser_example extends RecyclerView.Adapter<XmlPullParser_example.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        //binding
        holder.food_cd.setText(mList.get(position).title);
        holder.region_name.setText(mList.get(position).link);
        holder.month_name.setText(mList.get(position).mallName);
        holder.desk_kor.setText(mList.get(position).maker);
